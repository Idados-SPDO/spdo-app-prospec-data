...
FQN_MAIN = "BASES_SPDO.DB_COLETA_APP_PROSPECCAO_EMPRESAS.TB_EMPRESAS"
FQN_NEW = "BASES_SPDO.DB_COLETA_APP_PROSPECCAO_EMPRESAS.TB_EMPRESAS_UPDATE"
FQN_COMMENTS = "BASES_SPDO.DB_COLETA_APP_PROSPECCAO_EMPRESAS.TB_EMPRESAS_COMENTARIOS"
